...
files if preferred. Music is **not bundled**: optional personal music can be
placed at `Darkmoonshine_Theme/bgm.mp3` on your own SD. Launch **DarkMoonshine** from the Homebrew Channel and
