...
**Packaging correction:** the original ZIP hashes and ten-entry count below
describe the first package, before removal of bundled music. Current Wii
packages contain nine entries and no music. The published launcher/payload
bytes are preserved; see `darkmoonshine-1.0.0-music-cleanup.md`.
